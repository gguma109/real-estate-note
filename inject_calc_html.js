...
const calcUI = `
            <div id="content-calc" class="hidden flex-1 flex flex-col bg-gray-50 overflow-y-auto pb-24">
                ...
                <div class="p-4 space-y-4 max-w-lg mx-auto w-full">
                    ...
                    <!-- 복사 버튼 -->
                    <button onclick="copySettlement()" class="w-full bg-gray-800 hover:bg-gray-900 text-white font-bold py-4 rounded-xl shadow-lg transition-all flex justify-center items-center gap-2 active:scale-95">
...
if (!content.includes('id="content-calc"')) {
    content = content.replace('<div id="dev-login"', calcUI + '\n        <div id="dev-login"');
}
