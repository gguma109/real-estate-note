...
// .wrangler/tmp/bundle-kWb6Yj/checked-fetch.js
...
var require_checked_fetch2 = __commonJS2({
  "../.wrangler/tmp/bundle-eOpUBM/checked-fetch.js"() {
    var urls = /* @__PURE__ */ new Set();
    function checkURL(request, init) {
      const url = request instanceof URL ? request : new URL(
        (typeof request === "string" ? new Request(request, init) : request).url
...
async function onRequestPost3(context) {
  ...
  try {
    ...
    await env.DB.prepare(`
            ...
            (id, user_id, type, date, movein, address, room, deposit, premium, rent, yearly_rent, maintenance, inc_internet, inc_tv, inc_water, options, special_notes, phone)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(
      id,
      token,
...
//# sourceMappingURL=functionsWorker-0.612386255627075.js.map
