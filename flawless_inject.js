...
if (content.includes(gasBtnStr) && !content.includes('id="tab-calc"')) {
...
// 3. Add JS Logic at the very end before </script>
const jsLogicStr = `
        // ========== 연세 정산계산기 로직 ==========
...
console.log('Successfully injected exact PRORATION logic and UI via raw string replacement!');
